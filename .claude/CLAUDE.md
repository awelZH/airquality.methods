...
For coding and code-text and vignettes always use english (en), for reports: ask if english (en) or german (de). Plot text / annotations in reports should also match the report language.
